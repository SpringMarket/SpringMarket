...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, CandyResponseDetailDto> redisTemplateDto() {
        RedisTemplate<String, CandyResponseDetailDto> redisTemplate = new RedisTemplate<>();
