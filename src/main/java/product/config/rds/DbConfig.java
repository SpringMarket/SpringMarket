...
//        });
//
//        // TargetDataSources를 세팅하지만 앞서 재정의했듯이 해당 클래스가 Replica 이름을 리스트로 갖는 변수를 세팅하는 코드가 있음
...
//        return entityManagerFactoryBuilder.dataSource(dataSource()).packages("product").build();
//    }
//
